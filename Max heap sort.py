...
def increase_task_priority(task_heap,i,new_priority):
    pass
    if new_priority>=task_heap[int(i)].priority:  
        task_heap[int(i)].priority=new_priority
        while i>=1 and task_heap[int((i-1)/2)].priority<task_heap[int(i)].priority:
            A=task_heap[int(i)]
            task_heap[int(i)]=task_heap[int((i-1)/2)]
            task_heap[int((i-1)/2)]=A
            i=(i-1)/2
